...
public partial class Admin_Administracion_Agregar_Usuario : System.Web.UI.Page
{
            ...
            using (MiEscuelaDataContext context = new MiEscuelaDataContext())
            {
                ...
                if (u != null)
                {
                    ...
                    if (!continuar)
                    {
                        ...
                        Response.Write(MiEscuela.Common.Alert("No tiene usuarios disponibles para agregar", "/Admin/Inicio"));
                    }
                    else
                    {
    ...
    private bool Validar()
    {
        ...
        try
        {
            ...
            {
                if (!MiEscuela.Common.isEmail(txtEmail.Text))
                {
                    valido = false;
                    this.lblErrorEmail.Visible = true;
                }
