<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="Agregar-Usuario.aspx.cs" Inherits="Admin_Administracion_Agregar_Usuario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentBody" runat="Server">
    <div class="row ">
        <div class="col-md-12">
            <div style="float:right;"><a href="/Admin/Administracion/Inicio" class="btn green">Volver</a></div>
            <div role="form">
