<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master"  CodeFile="Docente.aspx.cs" Inherits="admin_Docente" %>
						...
						<div class="portlet light profile-sidebar-portlet">
							...
							<div class="profile-usertitle">
								...
								<div class="profile-usertitle-job">
                                    <asp:Label Text="2 Alumnos" ID="lblGrupos" runat="server" />
								</div>
							</div>
							...
							<div class="profile-usermenu">
								<ul class="nav">
									<li>
										<a href="/Admin/Mis-Escuelas" target="_blank">
								...
								<div class="portlet light">
									<div class="portlet-title tabbable-line">
										<div class="caption caption-md">
											...
											<span class="caption-subject font-blue-madison bold uppercase">Mis Grupos</span>
										</div>
