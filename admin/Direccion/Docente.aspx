<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Docente.aspx.cs" Inherits="admin_Direccion_Docente" %>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="portlet gren">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-camera"></i>Fotografía del Docente
                    </div>
                    ...
                    <div class="form-group input-xlarge">
                        ...
                        <div class="col-sm-12 col-md-12">
                            <h3>Grupos Asignados</h3>
                                <asp:ListBox runat="server" CssClass="form-control input-lg" ID="lstGrupos" SelectionMode="Multiple" Height="300px">
