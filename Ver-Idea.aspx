            ...
            <div class="portlet light bg-inverse">
                <div class="portlet-title">
                    ...
                    <% if (Page.User.Identity.IsAuthenticated)
                       { %>
                    <div class="actions">
                        <a href="" id="hlCalificarArea" runat="server" class="btn green">Califica esta idea</a>

                    </div>
                    <% } %>
                </div>
                <div class="portlet-body">
                    <div class="scroller" style="height: 150px" data-always-visible="1" data-rail-visible="1" data-rail-color="red" data-handle-color="green">
