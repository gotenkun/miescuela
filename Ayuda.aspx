<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Ayuda.aspx.cs" Inherits="Ayuda" %>
						...
						<div class="col-md-3">
							<ul class="ver-inline-menu tabbable margin-bottom-10">
								<li class="active">
									...
									<i class="fa fa-briefcase"></i> Preguntas Comunes </a>
									<span class="after">
									</span>
								</li>
								<li>
									<a data-toggle="tab" href="#tab_2">
									<i class="fa fa-group"></i> Registro e Inicio de Sesión </a>
								</li>
								<li>
									<a data-toggle="tab" href="#tab_3">
									<i class="fa fa-leaf"></i> Calificar Mi Escuela </a>
								</li>
								<li>
									<a data-toggle="tab" href="#tab_1">
									<i class="fa fa-info-circle"></i> Proponer una Idea </a>
								</li>
								<li>
									<a data-toggle="tab" href="#tab_2">
									<i class="fa fa-tint"></i> Revisar Tareas </a>
								</li>
								<li>
									<a data-toggle="tab" href="#tab_3">
									<i class="fa fa-plus"></i> Mensajes de usuarios </a>
								</li>
							</ul>
						</div>
						<div class="col-md-9">
